class Turtle : Reptile, ISwimmer
{
    ...
    public override string GetAnimalInformation()
    {
        string info = $"This animal is named: {Name}, it is {AgeInYears} years old, " +
            ...
            "4. A turtle’s shell isn’t just armor—it's actually fused with their spine and ribs, making it a permanent, living part of their body. They cannot crawl out of it like in cartoons. \n"
